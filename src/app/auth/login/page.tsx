    ...
    <div className="min-h-screen bg-surface-1 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <Card variant="elevated" padding="lg">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 text-text-2">
                <input
                  type="checkbox"
                  name="remember"
                  className="rounded border-surface-3 bg-surface-2 text-brand-cyan focus:ring-brand-cyan"
                />
                Remember me
              </label>
              <Link
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-surface-1 text-text-3">Or continue with</span>
            </div>
          </div>
        ...
        <p className="text-center mt-6 text-text-2 text-sm">
          ...
          <Link href="/auth/signup" className="text-brand-cyan hover:underline">
            Create one
          </Link>
        </p>
      </div>
