    ...
    <main className="min-h-screen bg-[#0B0F19] text-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              {/* Headline */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-6 animate-slide-up text-white">
                {HOMI_MESSAGING.hero.headline}
              </h1>

              {/* Subtitle */}
              <p className="text-lg text-gray-400 max-w-xl mb-8 animate-slide-up animation-delay-100">
              ...
              <div className="flex flex-wrap gap-4 mb-12 animate-slide-up animation-delay-200">
                <Link 
                  href="/register" 
                  className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-[#22d3ee] text-[#0B0F19] font-semibold text-lg hover:bg-[#06b6d4] transition-all duration-300 hover:scale-105 shadow-lg shadow-cyan-500/25"
                >
              ...
              <div className="flex flex-wrap gap-8 lg:gap-12 animate-slide-up animation-delay-300">
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-gray-500 uppercase tracking-wider mt-1">Receive &quot;NOT YET&quot;</span>
                </div>
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-gray-500 uppercase tracking-wider mt-1">Dimensions</span>
                </div>
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-gray-500 uppercase tracking-wider mt-1">Questions</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 lg:py-32 border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group bg-gradient-to-br from-cyan-500/5 to-emerald-500/5 border border-white/10 rounded-2xl p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:border-[#22d3ee] hover:shadow-xl hover:shadow-cyan-500/10">
            ...
            <div className="group bg-gradient-to-br from-cyan-500/5 to-emerald-500/5 border border-white/10 rounded-2xl p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:border-[#34d399] hover:shadow-xl hover:shadow-emerald-500/10">
            ...
            {/* Perfect Timing Card */}
            <div className="group bg-gradient-to-br from-cyan-500/5 to-emerald-500/5 border border-white/10 rounded-2xl p-8 text-center transition-all duration-300 hover:-translate-y-2 hover:border-[#facc15] hover:shadow-xl hover:shadow-yellow-500/10">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {HOMI_MESSAGING.model.dimensions.map((dimension) => (
              <div 
                key={dimension.key}
                className={`relative overflow-hidden rounded-2xl border border-white/10 p-8 transition-all duration-300 hover:border-opacity-50 ${
              ...
              >
                ...
                <p className="text-gray-400 leading-relaxed">{dimension.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 lg:py-32 border-t border-white/10">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          ...
          <div className="inline-block px-6 py-3 rounded-full bg-white/5 border border-white/10">
            <span className="text-gray-400 italic">&quot;{HOMI_MESSAGING.trust.line}&quot;</span>
          </div>
        </div>
      </section>

      {/* Insight Section */}
      <section className="py-24 lg:py-32 bg-gradient-to-r from-[#facc15]/5 to-[#34d399]/5 border-y border-white/10">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <div className="mb-8">
            <span className="text-6xl lg:text-8xl font-black bg-gradient-to-r from-[#facc15] to-[#34d399] bg-clip-text text-transparent">
              73%
            </span>
            <p className="text-lg text-gray-400 mt-4">of users receive NOT YET</p>
          </div>
      ...
      <section className="py-24 lg:py-32">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-cyan-500/10 to-emerald-500/10 border border-white/10 p-12 lg:p-16 text-center">
            {/* Background glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-[#22d3ee]/20 rounded-full blur-[128px] -z-10" />
            
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">Stop guessing. Start knowing.</h2>
            <p className="text-lg text-gray-400 mb-8">Join thousands who&apos;ve discovered their true readiness.</p>
            
            <Link 
              href="/register" 
              className="inline-flex items-center justify-center px-10 py-4 rounded-full bg-[#22d3ee] text-[#0B0F19] font-bold text-lg hover:bg-[#06b6d4] transition-all duration-300 hover:scale-105 shadow-xl shadow-cyan-500/25"
            >
              Get Started Free
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="text-center md:text-left">
              <h3 className="text-2xl font-bold text-white mb-1">HōMI</h3>
              <p className="text-sm text-gray-500">{HOMI_MESSAGING.brand.entity}</p>
            </div>
            ...
            <p className="text-sm text-gray-600">
              © 2026 {HOMI_MESSAGING.brand.name}. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
