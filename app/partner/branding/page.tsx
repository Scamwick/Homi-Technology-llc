...
export default function PartnerBrandingPage() {
  const [companyName, setCompanyName] = useState('Apex Financial Advisors');
  const [primaryColor, setPrimaryColor] = useState('#3b82f6');
  const [welcomeMessage, setWelcomeMessage] = useState(
    'Welcome to your Decision Readiness Assessment. Answer honestly for the most accurate results.'
  );
