export function verdictNotYetEmail(data: {
  name: string
  score: number
  ...
  const subject = `Your H\u014dMI-Score: ${score}/100 \u2014 Here's your path forward`

  const verdictColor =
    score >= 50 ? '#facc15' : score >= 30 ? '#fb923c' : '#f87171'
          ...
          <tr>
            <td style="background-color: #111d32; border-radius: 12px; padding: 40px 32px;">
              ...
              <p style="margin: 0 0 24px 0; font-size: 15px; line-height: 1.6; color: #cbd5e1;">
                Your assessment is complete. Here's where you stand right now.
              </p>
                ...
                <tr>
                  <td align="center" style="padding: 24px 0;">
                    <table role="presentation" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" style="background-color: #0a1628; border: 3px solid ${verdictColor}; border-radius: 16px; padding: 24px 48px;">
                          <span style="font-size: 48px; font-weight: 800; color: ${verdictColor}; letter-spacing: 1px;">${score}</span>
                          <span style="font-size: 20px; color: #64748b; font-weight: 600;">/100</span>
                          <br />
                          <span style="font-size: 14px; color: ${verdictColor}; font-weight: 700; text-transform: uppercase; letter-spacing: 2px;">NOT YET</span>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td style="padding: 0 0 24px 0; border-left: 3px solid ${verdictColor}; padding-left: 16px;">
                    ...
                    <p style="margin: 0; font-size: 15px; line-height: 1.6; color: #cbd5e1;">
                      A "Not Yet" verdict means you have areas to strengthen before making this commitment. H\u014dMI identified specific growth opportunities across your dimensions. This is your roadmap, not your ceiling.
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <!-- Dimension Bars -->
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="padding: 0 0 24px 0;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td align="center">
                    <a href="${appUrl}/transformation" target="_blank" style="display: inline-block; padding: 16px 40px; background-color: ${verdictColor}; color: #0a1628; font-size: 16px; font-weight: 700; text-decoration: none; border-radius: 8px; letter-spacing: 0.5px;">
                      View Your Transformation Path
                    </a>
                  </td>
                </tr>
              </table>
